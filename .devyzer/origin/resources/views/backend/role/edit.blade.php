        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="name" class="form-control" placeholder="{{  __('name') }} " value="{{   $role->title }}  "  required   />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="guard_name" class="form-control" placeholder="{{  __('guard_name') }} " value="{{   $role->title }}  "  required   />
                    </div>
