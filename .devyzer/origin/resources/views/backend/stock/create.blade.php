...
@section('title', __('Create Stock'))

@section('content')
    <x-forms.post :action="route('admin.stock.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create Stock')
            </x-slot>
            ...
            <x-slot name="body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="size_id" class="form-control" placeholder="{{  __('size_id') }} " value="{{  old('size_id') }} "  />
                    </div>
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Create Stock')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection